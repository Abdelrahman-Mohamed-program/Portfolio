import { Monitor, Wrench, Palette, Zap, Server, ArrowRight, Briefcase } from "lucide-react"
  ...
  return (
    <section ref={sectionRef} id="services" className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.span
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-400/30 rounded-full text-purple-300 text-sm mb-6 backdrop-blur-sm"
          ...
          >
            I provide comprehensive web development services to transform your digital vision into reality with cutting-edge technology and creative solutions.
          </motion.p>
        </motion.div>
