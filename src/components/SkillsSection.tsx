  ...
  const webDevSkills = [
    {
      ...
      icon: <SiReact className="w-4 h-4 text-cyan-400" />,
    },
    {
      name: "Node.js",
      level: 85,
    ...
    },
    {
      ...
      icon: <SiMongodb className="w-4 h-4 text-green-600" />,
    },
    {
      name: "JavaScript (ES6+)",
      level: 90,
    ...
    },
    {
      ...
      icon: <SiTailwindcss className="w-4 h-4 text-blue-500" />,
    },
    {
      name: "TypeScript",
      level: 65,
      color: "from-blue-600 to-blue-800",
      icon: <SiTypescript className="w-4 h-4 text-blue-600" />,
    },
    {
      name: "HTML5",
      level: 90,
  ...
  const programmingLanguages = [
    {
      ...
      icon: <SiCplusplus className="w-4 h-4 text-blue-600" />,
    },
    {
      name: "Python",
      level: 50,
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            technologies, programming languages, and essential soft skills for
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-12">
          ...
          <motion.div
            ...
            whileHover={{
              scale: 1.02,
              boxShadow:
                "0 25px 50px rgba(0,0,0,0.5), 0 0 30px rgba(20, 184, 166, 0.3)",
            }}
          >
          ...
          <motion.div
            ...
            whileHover={{
              scale: 1.02,
              boxShadow:
                "0 25px 50px rgba(0,0,0,0.5), 0 0 30px rgba(139, 92, 246, 0.3)",
            }}
          >
            <div className="flex items-center mb-8">
              <motion.div
        ...
        <motion.div
          ...
          whileHover={{
            scale: 1.01,
            boxShadow:
              "0 25px 50px rgba(0,0,0,0.5), 0 0 30px rgba(251, 146, 60, 0.25)",
          }}
        >
          <div className="flex items-center mb-8">
            <motion.div
              className="w-16 h-16 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-2xl flex items-center justify-center mr-4 shadow-lg"
              whileHover={{ scale: 1.1, rotate: 5 }}
            >
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                Production infrastructure experience from real competition
                stakes
              </p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            whileHover={{
              scale: 1.02,
              boxShadow:
                "0 25px 50px rgba(0,0,0,0.5), 0 0 30px rgba(59, 130, 246, 0.3)",
            }}
          >
          ...
          <motion.div
            ...
            whileHover={{
              scale: 1.02,
              boxShadow:
                "0 25px 50px rgba(0,0,0,0.5), 0 0 30px rgba(236, 72, 153, 0.3)",
            }}
          >
