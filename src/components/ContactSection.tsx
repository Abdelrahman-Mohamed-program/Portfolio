...
export function ContactSection() {
  ...
  const benefits = [
    ...
    { icon: <Server className="w-5 h-5" />, text: "Production-ready backend systems" },
    { icon: <Star className="w-5 h-5" />, text: "Responsive, mobile-first design" },
    { icon: <Zap className="w-5 h-5" />, text: "Fast communication, delivery & ongoing support" },
  ]
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <motion.input
                      ...
                      className={`w-full px-6 py-4 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:border-teal-400 focus:bg-white/10 outline-none transition-all duration-300 ${focusedField === "name" ? "shadow-lg shadow-teal-500/20" : ""}`}
                  ...
                  <div>
                    ...
                    <motion.input
                      ...
                      onBlur={() => setFocusedField(null)}
                      className={`w-full px-6 py-4 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:border-teal-400 focus:bg-white/10 outline-none transition-all duration-300 ${focusedField === "email" ? "shadow-lg shadow-teal-500/20" : ""}`}
                  ...
                  <div>
                    ...
                    <motion.textarea
                      ...
                      onBlur={() => setFocusedField(null)}
                      rows={5}
                      className={`w-full px-6 py-4 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:border-teal-400 focus:bg-white/10 outline-none transition-all duration-300 resize-none ${focusedField === "message" ? "shadow-lg shadow-teal-500/20" : ""}`}
                  ...
                  >
                    ...
                    <motion.div className="absolute inset-0 bg-gradient-to-r from-teal-600 to-blue-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  </motion.button>
                </form>
              ) : (
                <motion.div
